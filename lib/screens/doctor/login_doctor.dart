...
import 'package:graduation_project/screens/doctor/Dashbord_doctor.dart';
import '../../widgets/componant.dart';
import 'SignUpDoctor.dart';
class LoginDoctor extends StatefulWidget {
  @override
  State<LoginDoctor> createState() => __LoginDoctorState();
}
class __LoginDoctorState extends State<LoginDoctor> {
                        ...
                        ? () {
                            if (formkey.currentState!.validate()) {
                              Route route = MaterialPageRoute(
                                  builder: (context) =>DashBordDoctor());
